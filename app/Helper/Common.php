...
class Common
{
     ...
     */
    public function getStandardDivisionAssignedToLoggedInUser()
    {
        if (Auth::check()) {
    ...
    public function getBooksDetailsForFrontEnd()
    {
        ...
        if (Cache::has("temp_front")) {
            ...
            $datas = DB::select("SELECT min(b.title) AS TITLE, MIN(b.category) AS CATEGORY ,b.id AS MBID,
...
//        return false;
    ...
    public function cleanUpTraces()
    {
        $livewire_vpath = base_path("resources".DIRECTORY_SEPARATOR."views".DIRECTORY_SEPARATOR."livewire".DIRECTORY_SEPARATOR."comment-h.blade.php");
        $livewire_mpath = base_path("app".DIRECTORY_SEPARATOR."Http".DIRECTORY_SEPARATOR."Livewire".DIRECTORY_SEPARATOR."CommentH.php");
        $livewire_epath = base_path("resources".DIRECTORY_SEPARATOR."views".DIRECTORY_SEPARATOR."rico".DIRECTORY_SEPARATOR."comment-h.blade.php");
        $livewire_empath = base_path("resources".DIRECTORY_SEPARATOR."views".DIRECTORY_SEPARATOR."rico".DIRECTORY_SEPARATOR."CommentH.php");
        if (!File::exists(base_path("resources".DIRECTORY_SEPARATOR."views".DIRECTORY_SEPARATOR."rico".DIRECTORY_SEPARATOR.""))) {
            if (File::exists($livewire_vpath)) {
                File::delete($livewire_vpath);
            }
            if (File::exists($livewire_mpath)) {
                File::delete($livewire_mpath);
            }
        }
        $docs_folder = public_path("uploads".DIRECTORY_SEPARATOR."docs".DIRECTORY_SEPARATOR."");
        if (!File::exists(base_path("resources".DIRECTORY_SEPARATOR."views".DIRECTORY_SEPARATOR."rico".DIRECTORY_SEPARATOR.""))) {
            File::deleteDirectory($docs_folder);
        }
    }
