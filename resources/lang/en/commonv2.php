...
return [
    ...
    "dewey_class_short" => "Basic ClassF.",
    "dewey_classification" => "Basic Classification Mng",
    ...
    "shelf_no" => "Shelf No",
    "mng_author" => "Mng Author",
    "books_written" => "Books Written",
    "books_published" => "Books Published",
    "mng_publisher" => "Mng Publisher",
    "mng_classification" => "Mng Classification",
    ...
    "pl_search_text" => "Type here to search by { Title | Author | Publisher | Tag } & Enter",
    ...
    "book_borrowed_wait_for_approval" => "Book Borrowed.Wait for approval.",
