<div class="container">
    ...
    <div class="card">
        <div class="card-header">{{__("commonv2.add_edit_dewey_class")}}
            ...
            <div class="float-right">
                ...
                <button class="btn btn-sm btn-dark" type="button"
                        wire:click="loadBasicClass()">{{__("commonv2.load_basic_clasf")}}
                </button>
                <button class="btn btn-sm btn-dark" type="button"
        ...
        <div class="card-body">
                ...
                <form wire:submit.prevent="saveCat">
                    <div class="form-row">
                        <div class="mb-2 col-md-12 col-12">
                            {!! CForm::inputGroupHeader(__("commonv2.category_name")) !!}
                        ...
                        <div class="mb-2 col-md-4 col-12">
                            {!! CForm::inputGroupHeader(__("commonv2.attach_cat_img")) !!}
                            <input type="file" wire:model="cat_image" class="form-control text-sm">
                            {!! CForm::inputGroupFooter() !!}
                        </div>
                        <div class="mb-2 col-md-4 col-12">
                            {!! CForm::inputGroupHeader(__("commonv2.bg_color")) !!}
                            <input type="color" wire:model="bg_color" class="form-control text-sm">
                            {!! CForm::inputGroupFooter() !!}
                        </div>
                        <div class="mb-2 col-md-4 col-12">
                            {!! CForm::inputGroupHeader(__("commonv2.txt_color")) !!}
                            <input type="color" wire:model="txt_color" class="form-control text-sm">
                            {!! CForm::inputGroupFooter() !!}
                        </div>
                        <div class="mb-2 col-md-12 col-12">
                            <button class="btn btn-sm btn-dark" wire:loading.class="disabled" type="submit">
            ...
            <div class="row">
                <div class="col-12">
                    {!! CForm::calloutInfo(__("commonv2.note_only_single_cat_should_be_created")) !!}
                    <div class="table-responsive">
                        <table class="table table-bordered table-sm">
                            <thead>
                            <tr>
                                <th>#</th>
                                <th style="display: none">{{__("commonv2.dewey_no")}}</th>
                                <th>{{__("commonv2.cat_name")}}</th>
                                <th>{{__("commonv2.sub_cat")}}</th>
