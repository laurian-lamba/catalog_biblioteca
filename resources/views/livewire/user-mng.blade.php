<div>
    ...
    @if($form_mode=="add"|| $form_mode=="edit")
        <div id="frm_user_mng_holder" class="card card-dark">
            <div class="card-header"><span class="card-header-title">{{__("common.add_update_user_details")}}</span>
                            ...
                            <div class="col-md-9 col-12">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-md-6 mb-2">
                                        ...
                                        <select wire:model.defer="sel_course" class="form-control">
        ...
        <div class="card-body">
            ...
            <div class="form-row">
                ...
                <div class="form-group col-12">
                    ...
                    <button type="button" wire:click="printIdCards()" class="btn btn-sm btn-dark mb-3"><i
                ...
                <div class="form-group col-12">
                    <div class="table-responsive">
                        <table class="table table-bordered table-striped table-hover table-sm mt-1">
                            <thead>
                            <tr>
