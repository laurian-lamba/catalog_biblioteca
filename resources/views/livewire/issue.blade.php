                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-bordered table-striped table-sm">
                            ...
                            <tr>
                                <td scope="col">#</td>
                                <td scope="col">{{__("common.user_id")}}</td>
                                <td scope="col">{{__("common.user_img")}}</td>
                                <td scope="col">{{__("common.full_name")}}</td>
                                <td scope="col">{{__("common.book_id")}}</td>
                                <td scope="col">{{__("common.book_img")}}</td>
                                <td scope="col">{{__("commonv2.req_book")}}</td>
                                <td scope="col">{{__("common.created_on")}}</td>
                                <td scope="col">{{__("common.return_date")}}</td>
                                <td scope="col">{{__("common.action")}}</td>
                            </tr>
                            </thead>
                            <tbody>
                            ...
                            @foreach($books_pending as $item)
                                <tr>
                                    ...
                                    <td><input type="text" class="return_dt form-control"></td>
                                    <td>
