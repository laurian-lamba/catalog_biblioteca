                ...
                <div class="row">
                    <div class="col-md-3 col-12 mb-10" style="background-color: #e9ecef;padding-top: 2%;">
                        <div class="image_holder pb-3">
                            <img src="{{$util::isUrl($cover_img)?$cover_img:
                            ((isset($custom_img) && !is_null($custom_img) && !is_string($custom_img)) ? $custom_img->temporaryUrl()
                            : $util::fakeImage(300,250))}}" class="img-thumbnail"/>
                            <div class="mt-2">
                                {!! CForm::inputGroupHeader(__("common.upload_cover_image").CForm::generateInfoToolTip(__("common.pl_upload_img"))) !!}
                    ...
                    <div class="col-md-9 col-12 mb-10">
                        ...
                        <div class="row no-gutters">
                            <div class="form-group col-md-6 col-12">
                                {!! CForm::inputGroupHeader("ISBN".CForm::generateInfoToolTip(__('common.pl_isbn'))) !!}
                            ...
                            <div class="form-group col-md-6 col-12 author_holder p-1">
                                {!! CForm::inputGroupHeader(__("commonv2.authors")) !!}
                            ...
                            <div class="form-group col-md-6 col-12 publisher_holder p-1">
                            ...
                            <div class="form-group col-12">
                                ...
                                <div class="input-group-append">
                                    <a href="{{!empty($preview_url)?$preview_url:"#"}}" target="_blank"
                                       class="btn btn-dark"
                                       data-toggle="tooltip" data-placement="top"
                                       title="{{__("common.open_link")}}"><i
                            ...
                            <div class="form-group col-12">
                                {!! CForm::inputGroupHeader(__("common.upload_pdf").CForm::generateInfoToolTip(__("common.pl_pdf_file"))) !!}
                                <input type="file" wire:model.defer="custom_file" accept=".pdf"
                                       class="form-control text-xs">
                                <div class="input-group-append">
                                    <button type="button" wire:click="clearCustomUploadControl()"
                                            class="btn btn-dark"><i class="far fa-trash-alt"></i></button>
                                </div>
                                @error('custom_file')
                                <div class="w-100">
                                    @include('back.common.validation', ['message' =>  $common::reformatErrorMsg($message),"cls_name" => "word-wrap"  ])
                            ...
                            <div class="form-group col-md-12 col-12 tag_holder">
                                {!! CForm::inputGroupHeader(__("commonv2.tags")) !!}
                                {{--                                <input type="text" wire:model.defer="publisher" class="form-control">--}}
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="col-md col-12 mb-10">
                                                    <div class="form-row">
                                                        ...
                                                        <div class="col-md col-sm act_btn_holder">
                                                        ...
                                                        <div class="col-md col-sm">
                                                            {!! CForm::completeSelectBox(CForm::generateInfoToolTip(__("common.book_condition")),"pl-1",
                            ...
                            : $util::fakeImage(50,65))}}" class="img-thumbnail"/>
                                ...
                                <div class="card-footer pt-0 p-0">
                                    ...
                                    <button class="btn btn-sm btn-danger mb-1" wire:click="clearForm()"><i
