...
@section("content")
    <div class="content">
        <div class="container-fluid">
            <div class="card">
                <div class="card-header"><span class="card-header-title">{{{__("common.mng_notes")}}}</span>
                                                ...
                                                @php
                                                    ...
                                                    if($files){
                                                        foreach ($files as $filename){
                                                            array_push($links,"<a target='_blank' href='".asset('uploads/'.$filename)."'>".$filename."</a>");
                                                        }
                                                    }
                                                @endphp
                                                <td class="file_uploaded_td text-sm">{!!  $item->files_attached ? implode(",<br>",$links):"--" !!}</td>
                                                <td>{!!  !$item->note_status ? '<span class="badge badge-dark">'.__("common.draft").'</span>':
